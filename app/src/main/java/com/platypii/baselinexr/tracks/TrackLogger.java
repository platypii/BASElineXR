...
import com.platypii.baselinexr.util.StringBuilderUtil;
...
/**
 * Logs location data to a file.
 * AKA- The Black Box flight recorder
 */
public class TrackLogger implements Subscriber<MLocation> {
    ...
    /**
     * Listen for location updates (Subscriber interface)
     */
    @Override
    public void apply(@NonNull MLocation measure) {
